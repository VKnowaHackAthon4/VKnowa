...
public class Http2Utils {
    ...
    public static String doGet(String urlStr)
    {
        ...
        try
        {
            ...
            StringBuilder startTimeB = new StringBuilder(TimeUtils.getCurrentTimeInString());

            authStrB.append(HttpConstants.DEEPI_STRING_SPERATE);
            authStrB.append(HttpConstants.DEEPI_ACCESSKEY);
            authStrB.append(HttpConstants.DEEPI_STRING_SPERATE);
            authStrB.append(startTimeB);
            authStrB.append(HttpConstants.DEEPI_STRING_SPERATE);
            ...
            dataB.append(startTimeB);
            dataB.append(HttpConstants.DEEPI_DATA_ENDFIX);
